      ...
      try {
        ...
        const integratedStyles = `<style id="mrantiIntegratedRelationshipStyles">
          *,*::before,*::after{box-sizing:border-box}
          ...
          /* Context-aligned visual system: keep the network, remove the separate mini-app look. */
          .filter-row{display:grid!important;grid-template-columns:minmax(280px,1.35fr) minmax(220px,1fr) minmax(220px,1fr) auto!important;gap:8px!important}
          .filter-card{min-height:54px!important;padding:8px 10px!important;border:1px solid #cfe0ff!important;border-radius:10px!important;background:#fff!important;box-shadow:none!important}
          .filter-label{margin-bottom:3px!important;color:#64748b!important;font-size:9px!important;font-weight:750!important}
          .search-input,.select-input{font-size:11px!important;font-weight:650!important;color:#0f172a!important}
          .search-input::placeholder{color:#94a3b8!important}
          .reset-top{height:54px!important;min-width:86px!important;padding:0 14px!important;border:1px solid #cfe0ff!important;border-radius:10px!important;background:#fff!important;color:#2563eb!important;box-shadow:none!important;font-size:10px!important}
          .reset-top:hover{background:#eff6ff!important;border-color:#93c5fd!important}
          .legend-bar{padding:1px 2px 0!important;gap:10px!important}
          .legend-left{gap:14px!important}
          ...
          .main-workspace{gap:10px!important}
          .graph-panel,.detail-panel{border:1px solid #cfe0ff!important;border-radius:12px!important;box-shadow:none!important;background:#fff!important}
          .graph-panel{background:linear-gradient(180deg,#ffffff 0%,#f8fbff 100%)!important}
          .graph-panel::before{opacity:.24!important;background-image:linear-gradient(rgba(37,99,235,.07) 1px,transparent 1px),linear-gradient(90deg,rgba(37,99,235,.07) 1px,transparent 1px)!important;background-size:34px 34px!important;mask-image:none!important}
          .graph-panel::after{display:none!important}
          .zoom-tools{left:12px!important;top:48px!important;gap:4px!important;padding:5px!important;border:1px solid #dbeafe!important;border-radius:10px!important;box-shadow:0 4px 12px rgba(15,23,42,.06)!important;background:#fff!important}
          .zoom-btn{width:28px!important;height:28px!important;border-radius:7px!important;font-size:14px!important}
          .mini-map{left:14px!important;bottom:14px!important;width:120px!important;height:86px!important;border:1px solid #dbeafe!important;border-radius:10px!important;box-shadow:0 4px 12px rgba(15,23,42,.06)!important;background:rgba(255,255,255,.96)!important}
          .mini-map::before{width:88px!important;height:56px!important}
          .detail-panel{min-width:350px!important;padding:14px!important;gap:10px!important;background:#fff!important}
          .detail-head{padding-bottom:10px!important;border-bottom:1px solid #e5eefc!important}
          .avatar{width:38px!important;height:38px!important;border-radius:10px!important;background:#eff6ff!important;border:1px solid #bfdbfe!important;color:#2563eb!important;font-size:16px!important;box-shadow:none!important}
          .detail-title{font-size:15px!important;color:#0f172a!important}
          .detail-subtitle{font-size:10px!important;color:#64748b!important}
          .stat-grid{border:1px solid #dbeafe!important;border-radius:10px!important}
          .stat-box{padding:10px!important;border-color:#e5eefc!important}
          .stat-label{font-size:8.5px!important;text-transform:uppercase!important;letter-spacing:.35px!important}
          .stat-value{font-size:14px!important}
          .card-section{padding:11px!important;border:1px solid #dbeafe!important;border-radius:10px!important;background:#fff!important}
          .card-section.highlight{border-color:#bfdbfe!important;background:#f8fbff!important}
          .section-kicker{margin-bottom:6px!important;color:#2563eb!important;font-size:9px!important;text-transform:uppercase!important;letter-spacing:.25px!important}
          .section-copy{font-size:10.5px!important;line-height:1.45!important;color:#334155!important}
          .info-chip{padding:4px 7px!important;border-radius:999px!important;background:#eff6ff!important;border-color:#bfdbfe!important;color:#1d4ed8!important;font-size:9px!important}
          .history-list{gap:7px!important}
          .history-item{padding:9px!important;border:1px solid #e5eefc!important;border-radius:9px!important;background:#fff!important}
          .history-title{font-size:10.5px!important}
          .history-date,.history-meta{font-size:9px!important}
          .empty-state{padding:10px!important;border-color:#dbeafe!important;border-radius:9px!important;background:#f8fbff!important;font-size:10px!important}
          .node circle{animation:none!important;filter:drop-shadow(0 3px 5px rgba(15,23,42,.08))!important}
          .edge-flow{opacity:.28!important}

          @media(max-width:1050px){html,body{height:auto!important;min-height:100%!important;overflow:auto!important}.shell{height:auto!important;overflow:visible!important}.filter-row{grid-template-columns:1fr 1fr!important}.reset-top{width:100%!important}.main-workspace{height:auto!important;min-height:0!important;grid-template-columns:1fr!important;overflow:visible!important}.graph-panel{min-height:640px!important;height:640px!important}.detail-panel{min-width:0!important;min-height:520px!important;height:auto!important;overflow:visible!important}#graphSvg{min-height:640px!important;height:640px!important}}
        ...
        html = html
          .replace(/CRM Network/g, 'Relationship Context')
          .replace('Select any node to inspect meetings and relationship context.', 'Select a node to review its meetings and relationship context.')
