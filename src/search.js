(function initialiseCoreSearch(root, factory) {
  ...
  return Object.freeze({ normalize, tokens, tokenPrefixMatch, exactMatch, emailOrDomainMatch, partialPhoneMatch, validDateScore, recordOrderingScore, recordScore, graphScore });
});
